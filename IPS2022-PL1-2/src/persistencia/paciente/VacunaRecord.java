...
public class VacunaRecord {
    ...
    public VacunaRecord(int idVacuna, int idHistorial, String idCita,
	    LocalDate fechaReal, LocalDate fechaAproximada, LocalTime hora,
	    String dosis, boolean refuerzo) {
	super();
	...
	if (hora != null)
	    return dosis + (refuerzo ? "(refuerzo)" : "") + " "
		    + fechaReal.toString() + " a las " + hora.toString();
	else
	    return dosis + (refuerzo ? "(refuerzo)" : "") + " "
		    + fechaAproximada.toString();
    }
