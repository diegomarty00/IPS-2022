...
public class SolicitarCita extends JFrame {
	 ...
	 * Create the frame.
	 * 
	 * @param pacienteAsociado
	 */
	public SolicitarCita(PacienteRecord pacienteAsociado) {
		pac = pacienteAsociado;
	...
	private JButton getJbConfirmar() {
		if (jbConfirmar == null) {
			jbConfirmar = new JButton("Solicitar");
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (size > 0 || si > 0) {
				...
				if (cbAnio.getSelectedIndex() != -1 && cbMes.getSelectedIndex() != -1 && cbDia.getSelectedIndex() != -1
					...
					cc.SolicitarCita(pac.getId(), jChBUrgente.isSelected(),
	...
	private JPanel getPanelComboBox() {
		if (panelComboBox == null) {
			...
			panelComboBox.add(getTextField());
	...
	private JComboBox getComboBox_2_1() {
		if (cbLugar == null) {
			...
			cbLugar.setModel(new DefaultComboBoxModel(new String[] { "Consulta 1 ", "Consulta 2", "Consulta 3 ",
					"Consulta 4", "Consulta 5", "Consulta 6", "Consulta 7", "Consulta 8", "Consulta 9" }));
		}
		return cbLugar;
	}
	...
	private JCheckBox getRdbtnNewRadioButton() {
		if (jChBUrgente == null) {
			...
			jChBUrgente.setFont(new Font("Times New Roman", Font.BOLD, 14));
		}
		return jChBUrgente;
	}
	...
	private JComboBox getCbMes() {
		if (cbMes == null) {
			...
			cbMes.setModel(new DefaultComboBoxModel(
					new String[] { "01", "02", "03", "04", "05", "07", "08", "09", "10", "11", "12" }));
		}
		return cbMes;
	}
	...
	private JTextField getTextField() {
		if (textField == null) {
			...
			textField.setText(pac.toString());
