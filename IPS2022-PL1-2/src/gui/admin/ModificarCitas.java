...
public class ModificarCitas extends JFrame {
    ...
    private JComboBox<MedicoRecord> cbMedicos;
    ...
    private JList<MedicoCitaRecord> listMedicos;
    private DefaultListModel<MedicoCitaRecord> modjlist = new DefaultListModel<>();
    ...
    private JList<EspecialidadCitaRecord> listEspecialistas;
	 ...
	 * @param citaRecord 
	 */
	public ModificarCitas(CitaRecord citaRecord) {
		cita = citaRecord;
		...
		if (jbConfirmar == null) {
		    jbConfirmar = new JButton("Modificar cita");
		...
		if (jbAniadir == null) {
			...
			public void actionPerformed(ActionEvent e) {
				if(cbMedicos.getSelectedIndex() > 0 ) {
				    MedicoRecord me = (MedicoRecord) cbMedicos.getSelectedItem();
				    MedicoCitaRecord m = new MedicoCitaRecord();
				    m.idCita = cita.idCita;
				    m.idMedico = me.idMedico;
				    boolean b = true;
		...
		if (cbMedicos == null) {
		    ...
		    DefaultComboBoxModel<MedicoRecord> mod = new DefaultComboBoxModel<>();
		...
		if (btEliminar == null) {
			...
			public void actionPerformed(ActionEvent e) {
			    List<MedicoCitaRecord> el = listMedicos.getSelectedValuesList();
